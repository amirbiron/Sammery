...
- אל תשתמש ב-tldr
- אל תכתוב כמו רובוט
- הסר את כל הכוכביות (*) מהטקסט – אל תשתמש בכוכבית להדגשה
- ודא שכל פסקה מתחילה במילה עברית (לא באנגלית) כדי לשמור על יישור מימין לשמאל
- אל תציג את תאריכי הפוסטים בסיכום
